"""Generalized Navarro-Frenk-White profile via numerical integration."""
...
class gNFWIntegral(Profile):
    """
    Generalized Navarro-Frenk-White (gNFW) profile via numerical integration.
    ...
    This implementation uses adaptive quadrature for the Abel deprojection
    integral, which is accurate but computationally expensive.
    ...
    **kwargs
    ...
    integration), computed numerically using adaptive quadrature.
    """
    ...
    def _profile(r, Ic, rc, alpha, beta, gamma, rz, eps=1.00e-08):
        ...
        Computes the projected surface brightness profile by Abel
        transformation of a 3D density distribution.
