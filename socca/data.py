...
class FFTspec:
    ...
    def shift(self,xc,yc):
        ...
        uphase = -2.00j*jp.pi*self.freq[0]*(self.head['CRPIX1']-1.00+dx/jp.abs(self.head['CDELT1']))
        vphase =  2.00j*jp.pi*self.freq[1]*(self.head['CRPIX2']-1.00+dy/jp.abs(self.head['CDELT2']))
